...
export_html:
	...
	git clone https://github.com/awesome-selfhosted/awesome-selfhosted-html
...
.PHONY: add_sorting # appends the sort.js file to allow sorting for pages that have sortable projects
add_sorting:
	find html/html/tags -type f -name "*.html" | while read -r file; do \
        script_path="../_static/sort.js"; \
        sed -i '/<\/body>/s|</body>|<script src="'$$script_path'"></script>\n</body>|' "$$file"; \
    done
	sed -i '/<\/body>/s|</body>|<script src="_static/sort.js"></script>\n</body>|' html/html/index.html
